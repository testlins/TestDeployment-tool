...
#
# Created: Tue Dec 10 16:05:52 2013
...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Retry|QtGui.QDialogButtonBox.Save)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.gridLayoutWidget = QtGui.QWidget(dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 20, 781, 551))
        ...
        self.startappEdit.setReadOnly(False)
        ...
        self.updatepathEdit.setReadOnly(False)
        ...
        self.stopappEdit.setReadOnly(False)
        ...
        self.copypathEdit.setReadOnly(False)
        ...
        self.copypathEdit_2.setReadOnly(False)
    ...
    def retranslateUi(self, dialog):
        dialog.setWindowTitle(_translate("dialog", "编辑项目", None))
